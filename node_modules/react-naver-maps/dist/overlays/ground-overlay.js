...
module.exports = __toCommonJS(ground_overlay_exports);
...
var GroundOverlay = (0, import_react8.forwardRef)(function GroundOverlay2(props, ref) {
  const options = (0, import_lodash2.default)(props, kvoKeys);
  const { url, bounds } = props;
  const navermaps = useNavermaps();
  const [groundOverlay, setGroundOverlay] = (0, import_react8.useState)(() => new navermaps.GroundOverlay(url, bounds, options));
  (0, import_react8.useImperativeHandle)(ref, () => groundOverlay, [groundOverlay]);
