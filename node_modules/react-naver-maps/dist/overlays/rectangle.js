...
var Rectangle = (0, import_react8.forwardRef)(function Rectangle2(props, ref) {
  const options = (0, import_lodash2.default)(props, [...optionKeys, ...kvoKeys]);
  const navermaps = useNavermaps();
  const [rectangle] = (0, import_react8.useState)(() => new navermaps.Rectangle(options));
  (0, import_react8.useImperativeHandle)(ref, () => rectangle);
