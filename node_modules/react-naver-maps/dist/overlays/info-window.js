...
var info_window_exports = {};
__export(info_window_exports, {
  InfoWindow: () => InfoWindow
});
module.exports = __toCommonJS(info_window_exports);
...
var InfoWindow = (0, import_react8.forwardRef)(function InfoWindow2(props, ref) {
  const { position } = props;
  const navermaps = useNavermaps();
  const [infoWindow] = (0, import_react8.useState)(() => new navermaps.InfoWindow(omitUndefined((0, import_lodash2.default)(props, [...kvoKeys]))));
  (0, import_react8.useImperativeHandle)(ref, () => infoWindow);
  (0, import_react8.useEffect)(() => {
    infoWindow.setOptions(omitUndefined((0, import_lodash2.default)(props, primitiveKvoKeys)));
