...
var Circle = (0, import_react8.forwardRef)(function Circle2(props, ref) {
  const { center } = props;
  const navermaps = useNavermaps();
  const [circle] = (0, import_react8.useState)(() => new navermaps.Circle(omitUndefined((0, import_lodash2.default)(props, [...kvoKeys]))));
  (0, import_react8.useImperativeHandle)(ref, () => circle);
  ...
  (0, import_react8.useEffect)(() => {
    circle.setOptions(omitUndefined((0, import_lodash2.default)(props, primitiveKvoKeys)));
